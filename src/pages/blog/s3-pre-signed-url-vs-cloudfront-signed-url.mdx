...
<Image slug={frontmatter.slug} filename="01.png" altText="01.png" client:visible />
...
<Image slug={frontmatter.slug} filename="02.png" altText="02.png" client:visible />
...
<Image slug={frontmatter.slug} filename="03.png" altText="03.png" client:visible />

<Image slug={frontmatter.slug} filename="04.png" altText="04.png" client:visible />

แล้วลองเปิดไฟล์ด้วย presigned URL ที่ได้มาก็จะพบว่าสามารถเข้าถึงไฟล์ได้แล้ว

<Image slug={frontmatter.slug} filename="05.png" altText="05.png" client:visible />

พอ URL หมดอายุก็จะใช้งานไม่ได้อีก

<Image slug={frontmatter.slug} filename="06.png" altText="06.png" client:visible />
...
<Image slug={frontmatter.slug} filename="07.png" altText="07.png" client:visible />
...
<Image slug={frontmatter.slug} filename="08.png" altText="08.png" client:visible />
...
<Image slug={frontmatter.slug} filename="09.png" altText="09.png" client:visible />
...
<Image slug={frontmatter.slug} filename="10.png" altText="10.png" client:visible />

<Image slug={frontmatter.slug} filename="11.png" altText="11.png" client:visible />

พอตั้งค่าเสร็จแล้วลองเปิดรูปภาพด้วย URL เดิม จะพบว่าเปิดไม่ได้แล้ว เพราะไม่มี signature

<Image slug={frontmatter.slug} filename="12.png" altText="12.png" client:visible />
...
<Image slug={frontmatter.slug} filename="13.png" altText="13.png" client:visible />
