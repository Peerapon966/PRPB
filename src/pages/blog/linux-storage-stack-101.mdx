...
ที่ตั้งชื่อบทความเป็น 101 นี่เผื่อเอาไว้ในอนาคตอยากเขียนเกี่ยวกับเรื่องนี้ต่อ ก็จะเป็น 102, 103, ... ไปเรื่อย ๆ ไม่ได้มีความหมายอะไรเป็นพิเศษครับ ส่วนสำหรับ
ในบทความนี้ผมจะพูดถึงภาพรวมของ Linux storage stack คร่าว ๆ ครับ ศัพท์ตัวย่ออะไรที่เคยได้ยินมา เช่น SCSI, NVMe, NFS, EXT4, VFS, LVM มันคืออะไรกันแน่ 
ก็จะมาจัดระเบียบกันในบทความนี้ครับ
