...
slug: "s3-presigned-url-vs-cloudfront-signed-url"
thumbnail: true
---
...
<Link url="https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3/client/generate_presigned_url.html" />
...
<Image slug={frontmatter.slug} filename="11.png" altText="11.png" />

พอตั้งค่าเสร็จแล้วลองเปิดรูปภาพด้วย URL เดิม จะพบว่าเปิดไม่ได้แล้ว เพราะไม่มี signature

<Image slug={frontmatter.slug} filename="12.png" altText="12.png" />
...
<Image slug={frontmatter.slug} filename="13.png" altText="13.png" />
