...
โดยตอนที่เราสร้าง S3 presigned post request จะมี 5 อย่างที่เราสามารถกำหนดได้ ซึ่งจะเป็นตัวกำหนดว่า presigned post request ที่สร้างมาจะสามารถใช้อัปโหลดไฟล์อะไรได้บ้างแหละมีอายุเท่าไหร่
